...
export class AddProductComponent implements OnInit {
  ...
  async addProductTapped() {
    ...
    this.productRes = await (this._api
      .post('/sellers/' + this._user.getCurrentSeller().sellerId + '/products', this.productReqObj)
    ...
    this._api
      .post('/sellers/' + this._user.getCurrentSeller().sellerId + '/products/' + this.productRes.productId + '/images', this.imagePaths)
      .subscribe((data) => {
